...
function show_manager_center() {
    $.ajax({
        type: 'GET',
        url: '/account/work_list/get_all_work',
        async: true,
...
function show_work(work_list_id) {
    $.ajax({
        type: 'GET',
        url: '/account/work_list/edit/' + work_list_id,
        sync: true,
        success: function (data) {
...
function show_add_work_participants(section = []) {
    $.ajax({
        type: 'GET',
        url: '/account/work_list/get_user',
        async: true,
        success: function (data) {
            let strs = "";
            console.log(data)
...
function touch_announce(work_list_id) {
    ...
    $.ajax({
        type: 'POST',
        url: '/account/work_list/announce/' + work_list_id,
        sync: true,
        success: function (data) {
            // alert(data);
        },
...
function touch_finish(work_list_id) {
    ...
    $.ajax({
        type: 'POST',
        url: '/account/work_list/finish/' + work_list_id,
        sync: true,
        success: function (data) {
            // alert(data);
        },
...
function delete_work_list(work_list_id) {
    $.ajax({
        type: 'DELETE',
        url: '/account/work_list/delete/' + work_list_id,
        sync: false,
        success: function (data) {
