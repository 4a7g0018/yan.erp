...
function save_account_liabilities(year) {
    ...
    $.ajax({
        type: 'POST',
        url: '/gm/account/liabilities/save',
        data: form_data,
        dataType: 'json',
        processData: false,
        contentType: false,
...
function edit_account_liabilities(account_id,is_all=false) {
    ...
    $.ajax({
        ...
        type: 'GET',
        url: '/gm/account/liabilities/edit/' + account_id,
        async: false,
        success: function (data) {
            console.log(data);
...
function edit_save_liabilities(account_id) {
    ...
    $.ajax({
        type: 'POST',
        url: '/gm/account/liabilities/edit/save/' + account_id,
        data: form_data,
        dataType: 'json',
        processData: false,
        contentType: false,
...
function delete_account_liabilities(account_id) {
    ...
    if (account_id !== null) {
        $.ajax({
            type: 'DELETE',
            url: '/gm/account/liabilities/delete/' + account_id,
            async: false,
            success: function (data) {
                alert(data);
            },
