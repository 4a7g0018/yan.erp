...
function edit_account_expenses(account_id, is_all = false) {
    ...
    $.ajax({
        ...
        type: 'GET',
        url: '/gm/account/expenses/edit/' + account_id,
        async: false,
        success: function (data) {
            console.log(data);
...
function edit_save_expenses(account_id) {
    ...
    $.ajax({
        type: 'POST',
        url: '/gm/account/expenses/edit/save/' + account_id,
        data: form_data,
        dataType: 'json',
        processData: false,
        contentType: false,
...
function delete_account_expenses(account_id) {
    ...
    if (account_id !== null) {
        $.ajax({
            type: 'DELETE',
            url: '/gm/account/expenses/delete/' + account_id,
            async: false,
            success: function (data) {
                alert(data);
            },
