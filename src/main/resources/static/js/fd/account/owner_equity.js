function show_owner_equity_center(){
    $.ajax({
        type: 'GET',
        url: '/fd/account/owner_equity/get_owner_equity',
...
function save_account_owner_equity(year) {
    ...
    $.ajax({
        type: 'POST',
        url: '/fd/account/owner_equity/save',
        data: form_data,
        dataType: 'json',
        processData: false,
        contentType: false,
...
function edit_account_owner_equity(account_id,is_all=false) {
    ...
    $.ajax({
        ...
        type: 'GET',
        url: '/fd/account/owner_equity/edit/' + account_id,
        async: false,
        success: function (data) {
            console.log(data);
...
function edit_save_owner_equity(account_id) {
    ...
    $.ajax({
        type: 'POST',
        url: '/fd/account/owner_equity/edit/save/' + account_id,
        data: form_data,
        dataType: 'json',
        processData: false,
        contentType: false,
...
function delete_account_owner_equity(account_id) {
    ...
    if (account_id !== null) {
        $.ajax({
            type: 'DELETE',
            url: '/fd/account/owner_equity/delete/' + account_id,
            async: false,
            success: function (data) {
                alert(data);
            },
