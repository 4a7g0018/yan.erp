...
@RequestMapping("/account/work_list")
@Controller
@Slf4j
public class FinancialWorkListController {
    ...
    public ResponseEntity<List<String>> getUserNameList() {
        Long managerId = rolesServiceImpl.findRolesByName("ACCOUNT_MANAGER").getId();
        Long userId = rolesServiceImpl.findRolesByName("ACCOUNT_USER").getId();
